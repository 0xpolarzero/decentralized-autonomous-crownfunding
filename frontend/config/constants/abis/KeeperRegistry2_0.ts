export const KeeperRegistry2_0Abi = [
  {
    inputs: [
      {
        internalType: "contract KeeperRegistryBase2_0",
  ...
  { inputs: [], name: "OnchainConfigNonEmpty", type: "error" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "linkNative", type: "uint256" },
    ],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [],
    name: "getKeeperRegistryLogicAddress",
    outputs: [{ internalType: "address", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [],
    name: "getPaymentModel",
    outputs: [
      {
        internalType: "enum KeeperRegistryBase2_0.PaymentModel",
        name: "",
        type: "uint8",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum KeeperRegistryBase2_0.MigrationPermission",
        name: "",
        type: "uint8",
      },
    ],
  ...
  {
    inputs: [{ internalType: "bytes", name: "encodedUpkeeps", type: "bytes" }],
    name: "receiveUpkeeps",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "address[]", name: "payees", type: "address[]" }],
    name: "setPayees",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
